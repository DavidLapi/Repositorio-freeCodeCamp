# Revisión de Bucles y Secuencias
...
- **¿Cuándo usar una Tupla versus usar una Lista?:** Si necesita una colección dinámica de elementos donde pueda añadir, eliminar y actualizar elementos, entonces debe usar una lista. Si sabe que está trabajando con una colección fija e inmutable de datos, entonces debe usar una tupla.
...
- ***break* & *continue* statements:** Usados en bucles para modificar la ejecución de un bucle.
