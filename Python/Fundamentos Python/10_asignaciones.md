...
¿Cuál es una forma más eficiente de hacer esto? Se vería así:
...
1. ¿Cuál es la principal ventaja de usar operadores de asignación aumentada?

- [ ] Automáticamente convierten tipos de datos.
- [ ] Previenen todos los posibles errores de sintaxis.
- [X] Proporcionan una forma concisa de actualizar variables sin repetir el nombre de la variable.
- [ ] Hacen que las operaciones matemáticas sean más rápidas.

2. ¿Qué sucede cuando usas los operadores de incremento (++ ) y decremento (-- ) en Python?

- [ ] Funcionan exactamente igual que en C/C++.
- [ ] Causan un error de sintaxis y hacen que el programa se bloquee.
- [X] Se interpretan como operadores unaros dobles sin incremento/decremento real.
- [ ] Solo funcionan en Python 2, pero se eliminaron en Python 3.

3. ¿Qué operador de asignación aumentada eleva una variable a una potencia y almacena el resultado nuevamente en esa variable?
